# Generated by Django 4.1.1 on 2022-12-28 02:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('presented_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='faculty_member.research_presented')),
                ('published_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='faculty_member.research_published')),
            ],
        ),
        migrations.CreateModel(
