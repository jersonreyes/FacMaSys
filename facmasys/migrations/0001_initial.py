# Generated by Django 4.1.1 on 2022-12-30 00:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('extension_head', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='ref_extension_head', to=settings.AUTH_USER_MODEL)),
                ('faculty_id', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
